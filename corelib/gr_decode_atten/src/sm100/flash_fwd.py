...
class FlashAttentionForwardSm100:
    def __init__(
        ...
        _default_enable_ex2_emu = (
            ...
            or (self.head_dim_padded == 192 and self.use_2cta_instrs)
        ) and not is_sm103
    ...
    def __call__(
        ...
        if const_expr(self.enable_ex2_emu):
            ...
            if const_expr(self.pack_gqa and self.head_dim_padded > 64):
                self.ex2_emu_freq = (
                    32
    ...
    def mma(
        ...
        if const_expr(self.q_stage == 2):
            (tSrQ[None, None, None, 0], tSrQ[None, None, None, 1])
        else:
    ...
    def softmax_loop(
        ...
        (self.mma_tiler_qk[0] // thr_mma_qk.thr_id.shape, self.mma_tiler_qk[1])
