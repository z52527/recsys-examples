...
void run_hstu_bwd(Hstu_bwd_params &params, cudaStream_t stream) {
  ...
  typename CollectiveMainloop::Params mainloop_params = CollectiveMainloop::to_underlying_arguments({
      ...
      make_layout(make_shape(params.seqlen_k, params.seqlen_k, params.h_rab, params.b),
                  make_stride(params.drab_row_stride, _1{}, params.drab_head_stride, params.drab_batch_stride)),  // layout_dRab
      static_cast<Element const*>(params.qt_ptr),
      make_layout(make_shape(params.d, params.total_q, params.h),
                  make_stride(params.qt_row_stride, _1{}, params.qt_head_stride)),  // layout_Qt
      static_cast<Element const*>(params.dot_ptr),
      make_layout(make_shape(params.d, params.total_q, params.h),
                  make_stride(params.dot_row_stride, _1{}, params.dot_head_stride)),  // layout_dot
      static_cast<Element const*>(params.kt_ptr),
      make_layout(make_shape(params.d, params.total_k, params.h),
                  make_stride(params.kt_row_stride, _1{}, params.kt_head_stride)),  // layout_Kt
      params.b,
...
void run_hstu_bwd_(Hstu_bwd_params &params, cudaStream_t stream) {
  constexpr static bool Is_fp8 = cute::is_same_v<T, cutlass::float_e4m3_t> || cute::is_same_v<T, cutlass::float_e5m2_t>;
  static constexpr auto tile_size = flash::get_tile_size_bwd<Headdim, Has_rab, Is_fp8>();
