...
template <int kStages, class Gemm1Type, class Gemm2Type, class OutputType, class SmemLayoutQ,
          class SmemRabStorage, class SmemLayoutK, class SmemLayoutVt, class SmemLayoutO,
...
template <int kStages, class Gemm1Type, class Gemm2Type, class OutputType, class SmemLayoutQ,
          class SmemLayoutRab, class SmemLayoutK, class SmemLayoutVt, class SmemLayoutVtMma, class SmemLayoutO,
          class SmemLayoutValidBlockIds, class SmemLayoutMaxFunc, class SmemLayoutMinFunc>
...
template<int kHeadDim_, int kBlockM_, int kBlockN_, int kNWarps_, int kStages_,
         ...
         bool Is_arbitrary_, int kNFunc_, bool Has_rab_, int kClusterM_ = 1, typename elem_type=cutlass::half_t>
struct Hstu_fwd_kernel_traits {
  ...
  using SmemLayoutVt = decltype(tile_to_shape(
      SmemLayoutAtomVt{},
      make_shape(get<1>(TileShape_MNK_PV{}), get<2>(TileShape_MNK_PV{}), Int<kStages>{}), cute::Step<_2, _1, _3>{}));
  ...
  using SharedStorage = SharedStorageQRabKVO<kStages, Element, Element, Element, SmemLayoutQ,
                          SmemRabStorage, SmemLayoutK, SmemLayoutVt, SmemLayoutO, SmemLayoutValidBlockIds, SmemLayoutMaxFunc, SmemLayoutMinFunc>;
...
template<int kHeadDim_, int kBlockM_, int kBlockN_, int kNWarps_, int kStages_,
         bool Is_causal_, bool Is_context_, bool Is_target_, bool Is_local_,
         bool Is_arbitrary_, int kNFunc_, bool Has_rab_, int kClusterM_ = 1, int Quant_mode_ = 0>
struct Hstu_fwd_kernel_traits_fp8 {
  ...
  using SmemLayoutAtomRab = decltype(cutlass::gemm::collective::detail::ss_smem_selector<GMMA::Major::K, OutputType,
      decltype(cute::get<0>(TileShape_MNK{})), decltype(cute::get<1>(TileShape_MNK{}))>());
  using SmemLayoutRab =
      decltype(tile_to_shape(SmemLayoutAtomRab{},
                make_shape(shape<0>(TileShape_MNK{}), shape<1>(TileShape_MNK{}), Int<kStages>{})));
  ...
  using SmemLayoutVtTrans =
      decltype(composition(SmemLayoutVtMma{},
  ...
  using SharedStorage = SharedStorageQRabKVOVt<kStages, Element, Element, OutputType, SmemLayoutQ,
                          SmemLayoutRab, SmemLayoutK, SmemLayoutVt, SmemLayoutVtMma, SmemLayoutO,
                          SmemLayoutValidBlockIds, SmemLayoutMaxFunc, SmemLayoutMinFunc>;
...
struct Hstu_bwd_kernel_traits {
  ...
  static constexpr bool Mma_dQ_is_RS = AtomLayoutMSdP == NumMmaWarpGroups && AtomLayoutMdQ == NumMmaWarpGroups && !SdP_swapAB && !dQ_swapAB;
