...
struct CollectiveMainloopFwd {
  ...
  load(Params const &mainloop_params,
    ...
    Tensor gV = seqlen_traits_k.get_local_tile_tensorT(mV, select<1, 2>(TileShape_MNK_PV{}), bidh_kv, bidb);
  ...
  load_fp8(Params const &mainloop_params,
    ...
    auto [tVgV, tVsV] = tma_partition(mainloop_params.tma_load_V, block_rank_in_cluster, Layout<ClusterShape>{},
                                      group_modes<0, 2>(sVt), group_modes<0, 2>(gV));
  ...
  mma(Params const &mainloop_params,
    ...
    Tensor sK = make_tensor(make_smem_ptr(shared_storage.smem_k.data()), SmemLayoutK{});
    Tensor sRab = make_tensor(make_smem_ptr(shared_storage.smem_rab.data()), SmemLayoutRab{});
    Tensor sVt = make_tensor(make_smem_ptr(shared_storage.smem_v.data()), SmemLayoutVtMma{});
  ...
  mma_fp8(Params const &mainloop_params,
    ...
    Tensor sK = make_tensor(make_smem_ptr(shared_storage.smem_k.data()), SmemLayoutK{});
    Tensor sRab = make_tensor(make_smem_ptr(shared_storage.smem_rab.data()), SmemLayoutRab{});
    Tensor sVt = make_tensor(make_smem_ptr(Quant_mode != 1 ? shared_storage.smem_v_out.data() : shared_storage.smem_v.data()), SmemLayoutVtMma{});
