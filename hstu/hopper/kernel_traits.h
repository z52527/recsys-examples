...
template <int kStages, class Gemm1Type, class Gemm2Type, class OutputType, class SmemLayoutQ,
          class SmemLayoutRab, class SmemLayoutK, class SmemLayoutV, class SmemLayoutO>
...
template<int kHeadDim_, int kBlockM_, int kBlockN_, int kNWarps_, int kStages_, bool Has_Rab_, bool Is_Q_in_regs_=false,
...
struct Flash_fwd_kernel_traits_fp8 {
    ...
    // using SmemCopyAtomRab = Copy_Atom<cute::SM75_U32x4_LDSM_N, OutputType>;
    using SmemCopyAtomRab = Copy_Atom<cute::DefaultCopy, OutputType>;

    // TODO: Reduce the smem usage when Has_Rab=False
    using SharedStorage = SharedStorageQRabKVOVt<kStages, Element, Element, OutputType, SmemLayoutQ,
                            SmemLayoutRab, SmemLayoutK, SmemLayoutV, SmemLayoutO>;
